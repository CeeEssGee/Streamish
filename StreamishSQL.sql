...
VALUES
    (1, 'Groucho', 'groucho@marx.com', SYSDATETIME(), NULL, 'bbQnDfMGeCbI41cNMHftnl4sUkt2'),
    (2, 'Harpo', 'harpo@marx.com', SYSDATETIME(), NULL, '68Rrmk9EKEZaokymihp923XdLGh2'),
    (3, 'Chico', 'chico@marx.com', SYSDATETIME(), NULL, 'YFrvEqJ7xmQM6aMqqB6cgPlyfys1');
